...
\title{How Scandinavian of Me}
\subtitle{What are the challenges in incorporating web accessibility into the process of building public sector websites in Europe?}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Detta är inte den svenska översättningen av titeln}
\altsubtitle{Detta är inte den svenska översättningen av undertiteln}
% alternative, if the thesis is in Swedish, then give an English title
%\alttitle{This is the English translation of the title}
%\altsubtitle{This is the English translation of the subtitle}

\authorsLastname{Laakso}
\authorsFirstname{Toni}
\email{tlaakso@kth.se}
\kthid{u1r9cg2y}
\orcid{}
...
\secondorcid{}
\secondAuthorsSchool{\schoolAcronym{}}

\supervisorAsLastname{Laurell Thorslund}
\supervisorAsFirstname{Minna}
\supervisorAsEmail{minnalt@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorAsKTHID{u1bbqvnr}
\supervisorAsSchool{\schoolAcronym{EECS}}
\supervisorAsDepartment{Human Centered Technology}
...
\examinersLastname{Gulliksen}
\examinersFirstname{Jan}
\examinersEmail{gulliksen@kth.se}
% If the examiner is from within KTH add their KTHID, School and Department info
\examinersKTHID{u1wltav9}
